...
const mockContent = [
    ...
    { id: 15, title: 'SAT Math Practice Test', type: 'Exam Prep', icon: Icons.ClipboardCheck, tags: ['Math', 'SAT'] },
];
  ...
  return (
    <div className="kb-placeholder-container">
        <div className="kb-header">
            <div className="kb-header-icon"><Icons.ClipboardCheck size={48} /></div>
            <div>
                <h2 className="font-orbitron text-3xl font-bold text-white">Exam Prep</h2>
                <p className="text-gray-400">Exams / Exam Prep</p>
            </div>
        </div>
        ...
        <div className="kb-filter-bar">
            <div className="kb-search-wrapper">
                ...
                <input type="text" placeholder={`Search in Exam Prep...`} className="kb-search-input" />
            </div>

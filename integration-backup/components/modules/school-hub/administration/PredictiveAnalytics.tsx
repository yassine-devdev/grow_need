    ...
    const handleForecast = async () => {
        ...
        try {
            const schema = {
                type: "object",
                properties: {
                    trend_summary: { type: "string", description: 'A brief summary of the historical trend.' },
                    forecast: {
                        type: "array",
            ...
            const result = await aiProvider.generateJSON(prompt, schema, {
                system: "You are a school data analyst specializing in predictive analytics and forecasting educational trends.",
                temperature: 0.3,
                max_tokens: 1500
            });

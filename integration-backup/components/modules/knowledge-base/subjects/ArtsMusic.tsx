...
const ArtsMusic: React.FC = () => {
  return (
    <div className="kb-placeholder-container">
        <div className="kb-header">
            <div className="kb-header-icon"><Icons.Music size={48} /></div>
            <div>
                <h2 className="font-orbitron text-3xl font-bold text-white">Arts & Music</h2>
                <p className="text-gray-400">Subjects / Arts & Music</p>
            </div>
        </div>
        ...
        <div className="kb-filter-bar">
            <div className="kb-search-wrapper">
                ...
                <input type="text" placeholder={`Search in Arts & Music...`} className="kb-search-input" />
            </div>
